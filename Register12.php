...
if (isset($_POST['submitbtn'])) {
    ...
    $Shisha = new shisha($emri, $cmimi, $img, $pershkrimi, $edit);

    $ShishaRepository = new ShishaRepository();
    $ShishaRepository->insertShisha($emri, $cmimi, $img, $pershkrimi);
